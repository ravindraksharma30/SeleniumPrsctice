...
public class PeggedOrder {
	...
	@Id
	private BigDecimal virt_peg_ord_id;// Not Needed

	private BigDecimal sku_nbr; // Needed - skunumber - product number -
								// AL_DETAIL
	private String inb_ord_nbr; // Needed - po number AL_HEADER
	private String bol_nbr; // Needed - asn number - Where this goes?
	private BigDecimal peg_ord_qty;// Needed - Should it go as Allocated
	private String dest_loc_nbr;// May be Needed
	private String dest_loc_typ_cd;// DC - May be Needed
...
//	// AL_DETAIL
//	private BigDecimal peg_typ_cd;// May be Needed - What's this?
